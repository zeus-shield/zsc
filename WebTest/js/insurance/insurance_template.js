...
export default class InsuranceTemplate {
        ...
        contractInstance.size.estimateGas({from: this[account]}, function(error, result) {
            if(!error) {
                ...
                web3.eth.getGasPrice(function(error, result) {
                    if(!error) {
                        console.log("=============== InsuranceTemplate.size() ===============");
    ...
    getByName(name, func) {
        ...
        contractInstance.getByName.estimateGas(name, {from: this[account]}, function(error, result) {
            if(!error) {
                ...
                web3.eth.getGasPrice(function(error, result) {
                    if(!error) {
                        console.log("=============== InsuranceTemplate.getByName(bytes32) ===============");
                        console.log("from:    ", handler[account]);
                        console.log("gas:     ", gasRequired);
                        console.log("gasPrice:", result.toString(10));
                        console.log("===============================================================");
                        // call 'InsuranceTemplate.getByName(bytes32)'
