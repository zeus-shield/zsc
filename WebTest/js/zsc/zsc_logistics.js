            ...
            if(!error) {
                ...
                web3.eth.getGasPrice(function(error, result) {
                    if(!error) {
                        ...
                        contractInstance.number({from: handler[account], gas: gasRequired, gasPrice: result}, function(error, result) { 
                            if(!error) {
            ...
            if(!error) {
                ...
                web3.eth.getGasPrice(function(error, result) {
                    if(!error) {
                        ...
                        contractInstance.numberOfTracks(_num, {from: handler[account], gas: gasRequired, gasPrice: result}, function(error, result) { 
                            if(!error) {
                                Output(window.outputElement, 'small', 'red', `[Number]:${result}`);
                            } else {
                                Output(window.outputElement, 'small', 'red', error);
