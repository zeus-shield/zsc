...
library LibString {
    ...
    function findPtr(uint selflen, uint selfptr, uint needlelen, uint needleptr) private view returns (uint) {
        uint ptr;
        uint idx;
    ...
    */
    ...
    function compare(string _self, string _str) internal pure returns (int8 _ret) {
    ...
    function compareNoCase(string _self, string _str) internal pure returns (int8 _ret) {
        for (uint i=0; i<bytes(_self).length && i<bytes(_str).length; ++i) {
    ...
    function equals(string _self, string _str) internal pure returns (bool _ret) {
        if (bytes(_self).length != bytes(_str).length) {
            return false;
        }
    ...
    function equalsNoCase(string _self, string _str) internal pure returns (bool _ret) {
        if (bytes(_self).length != bytes(_str).length) {
            return false;
        }
    ...
    function substr(string _self, uint _start, uint _len) internal pure returns (string _ret) {
    ...
    function concat(string _self, string _str) internal pure returns (string _ret) {
    ...
    function concat(string _self, string _str1, string _str2)
        internal pure returns (string _ret) {
    ...
    function trim(string _self) internal pure returns (string _ret) {
        uint i;
        uint8 ch;
    ...
    function trim(string _self, string _chars) internal pure returns (string _ret) {
        uint16 i;
        uint16 j;
        bool matched;
        for (i=0; i<bytes(_self).length; ++i) {
    ...
    function indexOf(string _self, string _str) internal view returns (int _ret) {
        uint selfptr;
        uint strptr;
        assembly {
            selfptr := add(_self, 0x20)
    ...
    function indexOf(string _self, string _str, uint pos) internal view returns (int _ret) {
        uint selfptr;
        uint strptr;
        assembly {
            selfptr := add(_self, 0x20)
    ...
    function toInt(string _self) internal pure returns (int _ret) {
        _ret = 0;
    ...
    function fromHexChar(bytes1 _i) internal pure returns (int8 _ret){
        _ret = -1;
        int8 i = int8(_i);
        if (i >= 48 && i <= 57)
        {
    ...
    function toHex(string _self) internal pure returns (bytes _ret) {
    ...
    function toAddress(string _self) internal pure returns (address _ret) {
        uint16 i;
        uint8 digit;
        for (i=0; i<bytes(_self).length; ++i) {
            digit = uint8(bytes(_self)[i]);
    ...
    function toKeyValue(string _self, string _key) internal pure returns (string _ret) {
    ...
    function toKeyValue(string[] storage _self, string _key) internal view returns (string _ret) {
    ...
    function getStringValueByKey(string _self, string _key) internal view returns (string _ret) {
        int pos = -1;
        uint searchStart = 0;
        while (true) {
    ...
    function getIntValueByKey(string _self, string _key) internal view returns (int _ret) {
        _ret = 0;
        int pos = -1;
        uint searchStart = 0;
        while (true) {
    ...
    function getArrayValueByKey(string _self, string _key) internal view returns (string _ret) {
        int pos = -1;
        uint searchStart = 0;
        while (true) {
            pos = _self.indexOf("\"".concat(_key, "\""), searchStart);
    ...
    function keyExists(string _self, string _key) internal view returns (bool _ret) {
    ...
    function storageToUint(string _self) internal pure returns (uint _ret) {
        uint len = bytes(_self).length;
        if (len > 32) {
            len = 32;
        }
    ...
    function inArray(string _self, string[] storage _array) internal view returns (bool _ret) {
        for (uint i=0; i<_array.length; ++i) {
    ...
    function inArrayNoCase(string _self, string[] storage _array) internal view returns (bool _ret) {
        for (uint i=0; i<_array.length; ++i) {
    ...
    function addrToAsciiString(address x) internal pure returns (string) {
    ...
    function toChar(byte b) internal pure returns (byte c) {
        if (b < 10) return byte(uint8(b) + 0x30);
        else return byte(uint8(b) + 0x57);
    }

    function toUpper(string _self) internal pure returns (string _ret) {
        for (uint i=0; i<bytes(_self).length; ++i) {
    ...
    function toLower(string _self) internal pure returns (string _ret) {
        for (uint i=0; i<bytes(_self).length; ++i) {
            if (bytes(_self)[i] >= 'A' && bytes(_self)[i] <= 'Z') {
                bytes(_self)[i] |= 0x20;
            }
    ...
    function toUint(string _self) internal pure returns (uint _ret) {
        return uint(toInt(_self));
    }

    function toBytes32(string _self) internal pure returns (bytes32 _ret) {
        bytes memory str = bytes(_self);
        uint len = str.length;

        if (len > 32) len = 32;

        for (uint i=0; i < len; ++i) {
            _ret |= bytes32(str[i] & 0xFF) >> (i * 8);
        }
    }

    function bytes32ToString(bytes32 _self) internal pure returns (string _ret) {
        bytes memory bytesString = new bytes(32);
        uint8 len=0;
        for (uint j=0; j<32; j++) {
            byte char = byte(bytes32(uint(_self) * 2 ** (8 * j)));
            if (char != 0) {
                bytesString[j] = char;
                len++;
            }
        ...
        uint retptr;
        assembly {
            selfptr := add(bytesString, 0x20)
            retptr := add(_ret, 0x20)
        }

        memcpy(retptr, selfptr, len);
    }
  }